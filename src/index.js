...
class R2Player extends HTMLElement {
    constructor() {
        ...
        // Create the thumbnail preview container
        ...
        // Add the player container to the shadow DOM
        ...
        this.totalThumbnails = 256; // Adjust as necessary
    ...
    connectedCallback() {
        ...
        // Apply width and height using CSS variables
    ...
    initializePlayer() {
        ...
        if (Hls.isSupported()) {
            ...
            this.video.addEventListener('loadedmetadata', () => {
                ...
                // Note: Safari does not expose quality levels directly
                this.availableQualities = [];
                this.populateQualityMenu();
            });
        } else {
    ...
    initializeControls() {
        ...
        // Update buffered bar while video is loading
        ...
        // Show thumbnail preview on hover over progress bar
        progressContainer.addEventListener('mousemove', (e) => {
            ...
            // Position the thumbnail preview directly over the mouse
            ...
            // Ensure the thumbnail doesn't go out of the player container
        ...
        // Hide the thumbnail preview when the mouse leaves the progress bar
        ...
        // Update volume icon based on the state
        this.updateVolumeIcon(volumeButton);
        ...
        // Show volume slider on hover over the volume button or slider
        ...
        // Handle mouse activity to hide controls
        if (!this.controlsAlwaysVisible) {
    ...
    setInitialQuality() {
        if (this.defaultQuality === 'high') {
            ...
            // Set specific height if available
